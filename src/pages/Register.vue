<template>
  <main class="form-signin">
    <form @submit.prevent="submit">
      ...
      <input v-model="firstName" class="form-control" placeholder="姓" required>
      <input v-model="lastName" class="form-control" placeholder="名" required>
      ...
      <input v-model="passwordConfirm" type="password" class="form-control" placeholder="パスワード確認" required>
